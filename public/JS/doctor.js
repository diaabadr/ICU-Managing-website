            ...
            if (this.responseText != "") {
                ...
                console.log(patients);
                    for (i = 0; i < patients.length; i++) {
                        ...
                        icons.className = "icons prevent-click"
                        if (patients[i].nuresMessage != "") {
                            ...
                            icons.append(messageDiv);
                            patient.append(icons);
                        }
                        if (
                            ...
                            let icon = document.createElement("i");
                            icon.className = "complele-icon fa-solid fa-pen";
                            icons.append(icon);
                            patient.append(icons);
                        }
                ...
                document.querySelector(".doctor-patients").style.overflow = "hidden"
            }
    }
}
})
